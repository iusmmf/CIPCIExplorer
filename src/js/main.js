var colors = ["#f94144", "#f8961e", "#f9844a", "#f9c74f", "#90be6d", "#43aa8b", "#4d908e", "#577590", "#277da1", "#b5c7bc", "#c9ada7", "#9a8c98", "#a4a4a4", "#22223b"];
...
var areas2 = [];
var selectedRating = [];
var domainRateVal = [[0, 1, 2, 3, 4], [0], [0, 1, 2, 3, 4], [0], [0], [0, 1, 2, 3, 4], [0, 4], [0, 1, 2, 3, 4], [0], [0, 4], [0], [0], [0], [0]];
...
function transalteEng() {
  document.getElementById("text").src = "img/textENG.png";
...
function transalteJap() {
  document.getElementById("text").src = "img/textJAP.png";
...
map.on("load", function () {
  ...
  d3.json("data/minimap-points-01.geojson", function (err, data) {
    ...
    d3.json("data/cumulative2.geojson", function (err, dataCumulative) {
      ...
      dataCumulative.features = dataCumulative.features.map(function (d) {
        ...
        var indexExcep = exceptions.indexOf(d.properties[rateProperty[indexCategory]]);
        ...
        if (typeof scaled2 == "undefined" || scaled2 == null || isNaN(scaled2)) {
          ...
          d.properties["subCategory"] = domainButtons[indexCategory][0];
        } else {
          d.properties["rateTotal_" + fileNameRead] = scaled2;
          d.properties["subCategory"] = domainButtons[indexCategory][scaled2];
        }
      ...
      $("#buttons-group2 button").on("click", function (e) {
        ...
        clickedLayerMulti.forEach(function (item, i) {
      ...
      map.addLayer(
        {
          ...
          minzoom: 7,
          paint: {
            "circle-radius": ["interpolate", ["linear"], ["zoom"], 10, 2, 18, 10, 20, 20],
            "circle-opacity": 1,
            "circle-color": "#007ACC",
  ...
  d3.json("data/all_bikes_final3.geojson", function (err, data4) {
    if (err) throw err;
...
$("#arrow-mobile").click(function (e) {
  ...
  if (this.className == "active") {
    ...
    document.getElementById("map-console2").style.left = "-800px";
  } else {
    this.className = "active";
    //document.getElementById("arrow-mobile").innerHTML = "▼";
    document.getElementById("map-console2").style.left = "400px";
  }
});
