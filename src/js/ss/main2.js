var colors = ["#f3722c", "#f8961e", "#f9844a", "#f9c74f", "#90be6d", "#43aa8b", "#4d908e", "#577590", "#277da1", "#b5c7bc", "#c9ada7", "#9a8c98", "#a4a4a4", "#22223b"];
...
var fileName = ["buildings", "companies", "conventions", "embassies", "hospital", "hotels", "museums", "restaurants", "schools", "shoppingmalls", "stadiums", "stations", "theaters", "universities"];
...
var areas2 = [];
var selectedRating = [];
var domainRateVal = [[0, 1, 2, 3, 4], [0], [0, 1, 2, 3, 4], [0], [0], [0, 1, 2, 3, 4], [0, 4], [0, 1, 2, 3, 4], [0], [0], [0, 4], [0], [0], [0]];
...
var titlesE = [
  ["Buildings", "Buildings with a height of 100+ meters."],
  ["Companies", "Companies appearing in the Fortune Global 500 which also have their HQ in the target city."],
  ...
  ["Restaurants", "Restaurants with a Michelin star rating, as well as those with a Michelin Plate / Bib Gourmand."],
  ...
  d3.json("data/minimap-points-01.geojson", function (err, data) {
    ...
    d3.json("data/cumulative.geojson", function (err, dataCumulative) {
      ...
      $("#button-download").click(function () {
        ...
        // if (rendered.length < 21) {
        //   var limited = rendered.slice(0, limitFeatures);
        // } else {
        //   var limited = rendered;
        // }

        var featuresFiltered = turf.featureCollection(limited);

        // var obj = {};

        // for (var i = 0, len = featuresFiltered.length; i < len; i++) obj[featuresFiltered[i]["id"]] = featuresFiltered[i];

        // featuresFiltered = new Array();
        // for (var key in obj) featuresFiltered.push(obj[key]);

        //var propertiesToCsv = Object.keys(featuresFiltered.features[0].properties);
        ...
        propertiesToCsv2 = propertiesToCsv1.filter(onlyUnique);
